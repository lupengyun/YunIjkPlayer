...
static void
IjkMediaPlayer_setExternalRenderer(JNIEnv *env, jobject thiz, jlong ext_render)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    JNI_CHECK_GOTO(mp, env, NULL, "mpjni: setExternalRenderer: null mp", LABEL_RETURN);

    ijkmp_android_set_external_renderer(env, mp, ext_render);
...
static JNINativeMethod g_methods[] = {
    ...
    { "_setExternalRenderer",   "(J)V",     (void *) IjkMediaPlayer_setExternalRenderer },
